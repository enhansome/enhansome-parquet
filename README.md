...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,133 | 🐛 2,560 | 🌐 C++ | 📅 2026-09-17 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,752 | 🐛 1,336 | 🌐 C++ | 📅 2026-09-17 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,080 | 🐛 726 | 🌐 Java | 📅 2026-09-17 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 376 | 🐛 263 | 🌐 Java | 📅 2026-09-17 - A minimal dependency implementation of Apache Parquet.
...
* [Parquet.jl](https://github.com/JuliaIO/Parquet.jl) ⭐ 129 | 🐛 37 | 🌐 Julia | 📅 2026-09-08 - Julia implementation of Parquet columnar file format reader.
* [DuckDB](https://duckdb.org/docs/stable/clients/julia) - Official DuckDB Julia package.

### .NET

* [Parquet.Net](https://github.com/aloneguid/parquet-dotnet) ⭐ 909 | 🐛 37 | 🌐 C# | 📅 2026-08-25 - A fully managed Parquet library for .NET.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,133 | 🐛 2,560 | 🌐 C++ | 📅 2026-09-17 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,764 | 🐛 2,898 | 🌐 Rust | 📅 2026-09-17 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,080 | 🐛 726 | 🌐 Java | 📅 2026-09-17 - Java-based CLI tool for exploring parquet files.
* [ODBC to Parquet](https://github.com/pacman82/odbc2parquet) ⭐ 256 | 🐛 3 | 🌐 Rust | 📅 2026-09-16 - A command-line tool to query an ODBC data source and write the result into a parquet file.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,110 | 🐛 17 | 🌐 Rust | 📅 2026-09-15 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
* [parqeye](https://github.com/kaushiksrini/parqeye) ⭐ 678 | 🐛 14 | 🌐 Rust | 📅 2026-09-16 - Peek inside Parquet files right from your terminal.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,581 | 🐛 82 | 🌐 Thrift | 📅 2026-09-15 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 7,088 | 🐛 1,177 | 🌐 Rust | 📅 2026-09-17 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,200 | 🐛 327 | 🌐 Rust | 📅 2026-09-17 - A columnar file format designed for high-performance data processing.
