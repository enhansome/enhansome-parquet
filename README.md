...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,036 | 🐛 2,581 | 🌐 C++ | 📅 2026-08-20 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,731 | 🐛 1,317 | 🌐 C++ | 📅 2026-08-20 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,073 | 🐛 728 | 🌐 Java | 📅 2026-08-20 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 360 | 🐛 231 | 🌐 Java | 📅 2026-08-20 - A minimal dependency implementation of Apache Parquet.
...
* [ParquetSharp](https://g-research.github.io/ParquetSharp/) - A .NET wrapper over the C++ Parquet library that integrates with [.NET Arrow](https://github.com/apache/arrow-dotnet) ⭐ 36 | 🐛 45 | 🌐 C# | 📅 2026-08-18.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,036 | 🐛 2,581 | 🌐 C++ | 📅 2026-08-20 - The Ruby bindings of Apache Parquet, based on GObject Introspection.
...
* [Polars](https://github.com/pola-rs/polars) ⭐ 39,409 | 🐛 2,856 | 🌐 Rust | 📅 2026-08-20 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,073 | 🐛 728 | 🌐 Java | 📅 2026-08-20 - Java-based CLI tool for exploring parquet files.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,080 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,539 | 🐛 86 | 🌐 Thrift | 📅 2026-08-19 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [parquet-testing](https://github.com/apache/parquet-testing) ⭐ 90 | 🐛 22 | 🌐 Python | 📅 2026-08-12 - Testing Data and Utilities for Apache Parquet.

## Related formats

* [Lance](https://github.com/lancedb/lance) ⭐ 6,952 | 🐛 1,056 | 🌐 Rust | 📅 2026-08-20 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,147 | 🐛 354 | 🌐 Rust | 📅 2026-08-20 - A columnar file format designed for high-performance data processing.
