...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,086 | 🐛 2,591 | 🌐 C++ | 📅 2026-09-04 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,747 | 🐛 1,305 | 🌐 C++ | 📅 2026-09-05 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,078 | 🐛 727 | 🌐 Java | 📅 2026-09-05 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 369 | 🐛 260 | 🌐 Java | 📅 2026-09-05 - A minimal dependency implementation of Apache Parquet.
...
* [lakeql](https://github.com/earonesty/lakeql) ⭐ 11 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-31 - Pure JavaScript duck-compatible SQL query engine for Parquet and Iceberg data in object storage.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,086 | 🐛 2,591 | 🌐 C++ | 📅 2026-09-04 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,659 | 🐛 2,869 | 🌐 Rust | 📅 2026-09-05 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,078 | 🐛 727 | 🌐 Java | 📅 2026-09-05 - Java-based CLI tool for exploring parquet files.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,094 | 🐛 17 | 🌐 Rust | 📅 2026-09-05 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
* [parqeye](https://github.com/kaushiksrini/parqeye) ⭐ 677 | 🐛 15 | 🌐 Rust | 📅 2026-09-04 - Peek inside Parquet files right from your terminal.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 7,043 | 🐛 1,074 | 🌐 Rust | 📅 2026-09-05 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,177 | 🐛 361 | 🌐 Rust | 📅 2026-09-05 - A columnar file format designed for high-performance data processing.
