...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,095 | 🐛 2,594 | 🌐 C++ | 📅 2026-09-10 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,749 | 🐛 1,334 | 🌐 C++ | 📅 2026-09-10 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,078 | 🐛 729 | 🌐 Java | 📅 2026-09-10 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 371 | 🐛 275 | 🌐 Java | 📅 2026-09-10 - A minimal dependency implementation of Apache Parquet.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,095 | 🐛 2,594 | 🌐 C++ | 📅 2026-09-10 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,704 | 🐛 2,881 | 🌐 Rust | 📅 2026-09-10 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,078 | 🐛 729 | 🌐 Java | 📅 2026-09-10 - Java-based CLI tool for exploring parquet files.
* [ODBC to Parquet](https://github.com/pacman82/odbc2parquet) ⭐ 256 | 🐛 3 | 🌐 Rust | 📅 2026-09-10 - A command-line tool to query an ODBC data source and write the result into a parquet file.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,100 | 🐛 17 | 🌐 Rust | 📅 2026-09-09 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,572 | 🐛 85 | 🌐 Thrift | 📅 2026-09-07 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 7,061 | 🐛 1,122 | 🌐 Rust | 📅 2026-09-10 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,189 | 🐛 349 | 🌐 Rust | 📅 2026-09-10 - A columnar file format designed for high-performance data processing.
