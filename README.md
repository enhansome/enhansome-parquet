...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,060 | 🐛 2,589 | 🌐 C++ | 📅 2026-08-26 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,734 | 🐛 1,329 | 🌐 C++ | 📅 2026-08-26 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,076 | 🐛 740 | 🌐 Java | 📅 2026-08-25 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 363 | 🐛 252 | 🌐 Java | 📅 2026-08-26 - A minimal dependency implementation of Apache Parquet.
...
* [lakeql](https://github.com/earonesty/lakeql) ⭐ 9 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 - Pure JavaScript duck-compatible SQL query engine for Parquet and Iceberg data in object storage.
...
* [fastparquet](https://github.com/dask/fastparquet/) ⭐ 902 | 🐛 97 | 🌐 Python | 📅 2026-06-29 - A Python implementation of the Parquet columnar file format.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,060 | 🐛 2,589 | 🌐 C++ | 📅 2026-08-26 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,504 | 🐛 2,859 | 🌐 Rust | 📅 2026-08-26 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,076 | 🐛 740 | 🌐 Java | 📅 2026-08-25 - Java-based CLI tool for exploring parquet files.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,089 | 🐛 15 | 🌐 Rust | 📅 2026-08-26 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 6,973 | 🐛 1,062 | 🌐 Rust | 📅 2026-08-26 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,158 | 🐛 366 | 🌐 Rust | 📅 2026-08-26 - A columnar file format designed for high-performance data processing.
...
* [Nimble](https://github.com/facebookincubator/nimble) ⭐ 728 | 🐛 150 | 🌐 C++ | 📅 2026-08-07 - File format for storage of large columnar datasets.
