...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,069 | 🐛 2,583 | 🌐 C++ | 📅 2026-08-28 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,739 | 🐛 1,298 | 🌐 C++ | 📅 2026-08-29 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,078 | 🐛 739 | 🌐 Java | 📅 2026-08-25 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 366 | 🐛 245 | 🌐 Java | 📅 2026-08-28 - A minimal dependency implementation of Apache Parquet.
...
* [lakeql](https://github.com/earonesty/lakeql) ⭐ 10 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 - Pure JavaScript duck-compatible SQL query engine for Parquet and Iceberg data in object storage.
...
* [Parquet.Net](https://github.com/aloneguid/parquet-dotnet) ⭐ 905 | 🐛 35 | 🌐 C# | 📅 2026-08-25 - A fully managed Parquet library for .NET.
* [ParquetSharp](https://g-research.github.io/ParquetSharp/) - A .NET wrapper over the C++ Parquet library that integrates with [.NET Arrow](https://github.com/apache/arrow-dotnet) ⭐ 37 | 🐛 43 | 🌐 C# | 📅 2026-08-25.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,069 | 🐛 2,583 | 🌐 C++ | 📅 2026-08-28 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,535 | 🐛 2,869 | 🌐 Rust | 📅 2026-08-28 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,078 | 🐛 739 | 🌐 Java | 📅 2026-08-25 - Java-based CLI tool for exploring parquet files.
...
* [parquet-cli-standalone](https://github.com/marcelmay/parquet-cli-standalone) ⭐ 5 | 🐛 0 | 🌐 Java | 📅 2026-08-17 - A JAR file for the parquet-cli tool which can be run without any dependencies.
...
* [KoldStore](https://github.com/kalamdb/koldstore) ⭐ 5 | 🐛 52 | 🌐 Rust | 📅 2026-08-28 - PostgreSQL tiered storage that moves historical rows to Parquet while keeping the original table fully queryable and supporting updates and deletes.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,090 | 🐛 15 | 🌐 Rust | 📅 2026-08-26 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
* [parqeye](https://github.com/kaushiksrini/parqeye) ⭐ 676 | 🐛 15 | 🌐 Rust | 📅 2026-08-26 - Peek inside Parquet files right from your terminal.
* [Datanomy](https://github.com/raulcd/datanomy) ⭐ 432 | 🐛 15 | 🌐 Python | 📅 2026-05-21 - A terminal-based tool for visualizing a Parquet file's metadata and structure.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,556 | 🐛 88 | 🌐 Thrift | 📅 2026-08-27 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 6,990 | 🐛 1,069 | 🌐 Rust | 📅 2026-08-29 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,161 | 🐛 378 | 🌐 Rust | 📅 2026-08-29 - A columnar file format designed for high-performance data processing.
