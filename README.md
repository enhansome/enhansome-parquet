...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,142 | 🐛 2,551 | 🌐 C++ | 📅 2026-09-20 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,756 | 🐛 1,346 | 🌐 C++ | 📅 2026-09-20 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,081 | 🐛 734 | 🌐 Java | 📅 2026-09-20 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 377 | 🐛 265 | 🌐 Java | 📅 2026-09-18 - A minimal dependency implementation of Apache Parquet.
...
* [ParquetSharp](https://g-research.github.io/ParquetSharp/) - A .NET wrapper over the C++ Parquet library that integrates with [.NET Arrow](https://github.com/apache/arrow-dotnet) ⭐ 40 | 🐛 41 | 🌐 C# | 📅 2026-09-14.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,142 | 🐛 2,551 | 🌐 C++ | 📅 2026-09-20 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,815 | 🐛 2,898 | 🌐 Rust | 📅 2026-09-20 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,081 | 🐛 734 | 🌐 Java | 📅 2026-09-20 - Java-based CLI tool for exploring parquet files.
* [ODBC to Parquet](https://github.com/pacman82/odbc2parquet) ⭐ 256 | 🐛 3 | 🌐 Rust | 📅 2026-09-18 - A command-line tool to query an ODBC data source and write the result into a parquet file.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,114 | 🐛 17 | 🌐 Rust | 📅 2026-09-20 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,584 | 🐛 84 | 🌐 Thrift | 📅 2026-09-20 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 7,101 | 🐛 1,222 | 🌐 Rust | 📅 2026-09-20 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,206 | 🐛 329 | 🌐 Rust | 📅 2026-09-20 - A columnar file format designed for high-performance data processing.
