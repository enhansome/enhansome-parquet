...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,080 | 🐛 2,593 | 🌐 C++ | 📅 2026-09-03 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,742 | 🐛 1,302 | 🌐 C++ | 📅 2026-09-03 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,078 | 🐛 730 | 🌐 Java | 📅 2026-09-03 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 368 | 🐛 254 | 🌐 Java | 📅 2026-09-02 - A minimal dependency implementation of Apache Parquet.
...
* [Parquet.Net](https://github.com/aloneguid/parquet-dotnet) ⭐ 907 | 🐛 35 | 🌐 C# | 📅 2026-08-25 - A fully managed Parquet library for .NET.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,080 | 🐛 2,593 | 🌐 C++ | 📅 2026-09-03 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,636 | 🐛 2,871 | 🌐 Rust | 📅 2026-09-03 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,078 | 🐛 730 | 🌐 Java | 📅 2026-09-03 - Java-based CLI tool for exploring parquet files.
...
* [Tad](https://github.com/antonycourtney/tad) ⭐ 3,480 | 🐛 166 | 🌐 TypeScript | 📅 2025-03-05 - An application for viewing and analyzing tabular data sets.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,093 | 🐛 17 | 🌐 Rust | 📅 2026-09-03 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
* [parqeye](https://github.com/kaushiksrini/parqeye) ⭐ 676 | 🐛 14 | 🌐 Rust | 📅 2026-09-03 - Peek inside Parquet files right from your terminal.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,564 | 🐛 85 | 🌐 Thrift | 📅 2026-09-03 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 7,032 | 🐛 1,050 | 🌐 Rust | 📅 2026-09-03 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,175 | 🐛 366 | 🌐 Rust | 📅 2026-09-03 - A columnar file format designed for high-performance data processing.
