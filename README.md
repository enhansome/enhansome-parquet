...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,095 | 🐛 2,591 | 🌐 C++ | 📅 2026-09-09 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,749 | 🐛 1,344 | 🌐 C++ | 📅 2026-09-09 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,079 | 🐛 729 | 🌐 Java | 📅 2026-09-09 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 371 | 🐛 271 | 🌐 Java | 📅 2026-09-09 - A minimal dependency implementation of Apache Parquet.
...
* [ParquetSharp](https://g-research.github.io/ParquetSharp/) - A .NET wrapper over the C++ Parquet library that integrates with [.NET Arrow](https://github.com/apache/arrow-dotnet) ⭐ 39 | 🐛 44 | 🌐 C# | 📅 2026-09-07.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,095 | 🐛 2,591 | 🌐 C++ | 📅 2026-09-09 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,696 | 🐛 2,869 | 🌐 Rust | 📅 2026-09-09 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,079 | 🐛 729 | 🌐 Java | 📅 2026-09-09 - Java-based CLI tool for exploring parquet files.
...
* [parquet-cli-standalone](https://github.com/marcelmay/parquet-cli-standalone) ⭐ 5 | 🐛 1 | 🌐 Java | 📅 2026-09-09 - A JAR file for the parquet-cli tool which can be run without any dependencies.
...
* [Tad](https://github.com/antonycourtney/tad) ⭐ 3,477 | 🐛 166 | 🌐 TypeScript | 📅 2025-03-05 - An application for viewing and analyzing tabular data sets.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,099 | 🐛 17 | 🌐 Rust | 📅 2026-09-09 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,571 | 🐛 85 | 🌐 Thrift | 📅 2026-09-07 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 7,054 | 🐛 1,114 | 🌐 Rust | 📅 2026-09-09 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,186 | 🐛 354 | 🌐 Rust | 📅 2026-09-09 - A columnar file format designed for high-performance data processing.
