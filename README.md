...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,093 | 🐛 2,590 | 🌐 C++ | 📅 2026-09-08 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,748 | 🐛 1,327 | 🌐 C++ | 📅 2026-09-08 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,079 | 🐛 726 | 🌐 Java | 📅 2026-09-08 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 370 | 🐛 268 | 🌐 Java | 📅 2026-09-08 - A minimal dependency implementation of Apache Parquet.
* [parquet-carpet](https://github.com/jerolba/parquet-carpet) ⭐ 95 | 🐛 3 | 🌐 Java | 📅 2026-08-19 - A Java library for serializing and deserializing Parquet files efficiently using Java records.
* [duckdb-java](https://duckdb.org/docs/stable/clients/java) - DuckDB Java/JDBC API.

### JavaScript

* [lakeql](https://github.com/earonesty/lakeql) ⭐ 11 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-07 - Pure JavaScript duck-compatible SQL query engine for Parquet and Iceberg data in object storage.
...
* [Parquet.jl](https://github.com/JuliaIO/Parquet.jl) ⭐ 128 | 🐛 37 | 🌐 Julia | 📅 2026-09-08 - Julia implementation of Parquet columnar file format reader.
* [DuckDB](https://duckdb.org/docs/stable/clients/julia) - Official DuckDB Julia package.

### .NET

* [Parquet.Net](https://github.com/aloneguid/parquet-dotnet) ⭐ 907 | 🐛 37 | 🌐 C# | 📅 2026-08-25 - A fully managed Parquet library for .NET.
* [ParquetSharp](https://g-research.github.io/ParquetSharp/) - A .NET wrapper over the C++ Parquet library that integrates with [.NET Arrow](https://github.com/apache/arrow-dotnet) ⭐ 39 | 🐛 43 | 🌐 C# | 📅 2026-09-07.
...
* [fastparquet](https://github.com/dask/fastparquet/) ⭐ 904 | 🐛 97 | 🌐 Python | 📅 2026-06-29 - A Python implementation of the Parquet columnar file format.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,093 | 🐛 2,590 | 🌐 C++ | 📅 2026-09-08 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,687 | 🐛 2,875 | 🌐 Rust | 📅 2026-09-08 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,079 | 🐛 726 | 🌐 Java | 📅 2026-09-08 - Java-based CLI tool for exploring parquet files.
* [ODBC to Parquet](https://github.com/pacman82/odbc2parquet) ⭐ 256 | 🐛 3 | 🌐 Rust | 📅 2026-09-08 - A command-line tool to query an ODBC data source and write the result into a parquet file.
...
* [parquet-cli-standalone](https://github.com/marcelmay/parquet-cli-standalone) ⭐ 5 | 🐛 3 | 🌐 Java | 📅 2026-09-07 - A JAR file for the parquet-cli tool which can be run without any dependencies.
...
* [Tad](https://github.com/antonycourtney/tad) ⭐ 3,478 | 🐛 166 | 🌐 TypeScript | 📅 2025-03-05 - An application for viewing and analyzing tabular data sets.
* [DBConvert Streams](https://github.com/slotix/dbconvert-streams-public) ⭐ 24 | 🐛 3 | 🌐 Dockerfile | 📅 2026-09-05 - A desktop SQL tool for querying Parquet, CSV, JSON, databases, and S3-compatible storage in one workspace.
...
* [KoldStore](https://github.com/kalamdb/koldstore) ⭐ 5 | 🐛 52 | 🌐 Rust | 📅 2026-08-31 - PostgreSQL tiered storage that moves historical rows to Parquet while keeping the original table fully queryable and supporting updates and deletes.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,097 | 🐛 18 | 🌐 Rust | 📅 2026-09-06 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
* [parqeye](https://github.com/kaushiksrini/parqeye) ⭐ 678 | 🐛 16 | 🌐 Rust | 📅 2026-09-08 - Peek inside Parquet files right from your terminal.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,570 | 🐛 85 | 🌐 Thrift | 📅 2026-09-07 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [parquet-testing](https://github.com/apache/parquet-testing) ⭐ 90 | 🐛 21 | 🌐 Python | 📅 2026-09-03 - Testing Data and Utilities for Apache Parquet.

## Related formats

* [Lance](https://github.com/lancedb/lance) ⭐ 7,054 | 🐛 1,080 | 🌐 Rust | 📅 2026-09-08 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,184 | 🐛 353 | 🌐 Rust | 📅 2026-09-08 - A columnar file format designed for high-performance data processing.
* [F3](https://github.com/future-file-format/F3) ⭐ 766 | 🐛 1 | 🌐 Rust | 📅 2025-11-03 - A data file format that is designed with efficiency, interoperability, and extensibility in mind.
* [Nimble](https://github.com/facebookincubator/nimble) ⭐ 733 | 🐛 150 | 🌐 C++ | 📅 2026-08-07 - File format for storage of large columnar datasets.
