...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,144 | 🐛 2,544 | 🌐 C++ | 📅 2026-09-21 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,759 | 🐛 1,344 | 🌐 C++ | 📅 2026-09-21 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,081 | 🐛 732 | 🌐 Java | 📅 2026-09-21 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 377 | 🐛 267 | 🌐 Java | 📅 2026-09-21 - A minimal dependency implementation of Apache Parquet.
...
* [Parquet.Net](https://github.com/aloneguid/parquet-dotnet) ⭐ 909 | 🐛 38 | 🌐 C# | 📅 2026-08-25 - A fully managed Parquet library for .NET.
* [ParquetSharp](https://g-research.github.io/ParquetSharp/) - A .NET wrapper over the C++ Parquet library that integrates with [.NET Arrow](https://github.com/apache/arrow-dotnet) ⭐ 40 | 🐛 41 | 🌐 C# | 📅 2026-09-21.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,144 | 🐛 2,544 | 🌐 C++ | 📅 2026-09-21 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,831 | 🐛 2,902 | 🌐 Rust | 📅 2026-09-21 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [duckdb-vba](https://github.com/EtienneLenoir/duckdb-vba) ⭐ 10 | 🐛 0 | 🌐 VBA | 📅 2026-06-11 - Excel/VBA bridge for DuckDB, enabling users to read, query, transform, and export Parquet files directly from Excel through a native DLL bridge.

## Tools

### Command-line

* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,081 | 🐛 732 | 🌐 Java | 📅 2026-09-21 - Java-based CLI tool for exploring parquet files.
* [ODBC to Parquet](https://github.com/pacman82/odbc2parquet) ⭐ 256 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - A command-line tool to query an ODBC data source and write the result into a parquet file.
...
* [Tad](https://github.com/antonycourtney/tad) ⭐ 3,480 | 🐛 163 | 🌐 TypeScript | 📅 2025-03-05 - An application for viewing and analyzing tabular data sets.
...
* [KoldStore](https://github.com/kalamdb/koldstore) ⭐ 6 | 🐛 52 | 🌐 Rust | 📅 2026-08-31 - PostgreSQL tiered storage that moves historical rows to Parquet while keeping the original table fully queryable and supporting updates and deletes.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,117 | 🐛 17 | 🌐 Rust | 📅 2026-09-20 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,587 | 🐛 86 | 🌐 Thrift | 📅 2026-09-20 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 7,104 | 🐛 1,220 | 🌐 Rust | 📅 2026-09-21 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,213 | 🐛 329 | 🌐 Rust | 📅 2026-09-21 - A columnar file format designed for high-performance data processing.
* [F3](https://github.com/future-file-format/F3) ⭐ 770 | 🐛 1 | 🌐 Rust | 📅 2025-11-03 - A data file format that is designed with efficiency, interoperability, and extensibility in mind.
* [Nimble](https://github.com/facebookincubator/nimble) ⭐ 735 | 🐛 151 | 🌐 C++ | 📅 2026-09-21 - File format for storage of large columnar datasets.
