...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,092 | 🐛 2,585 | 🌐 C++ | 📅 2026-09-07 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,747 | 🐛 1,321 | 🌐 C++ | 📅 2026-09-07 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,078 | 🐛 728 | 🌐 Java | 📅 2026-09-07 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 370 | 🐛 268 | 🌐 Java | 📅 2026-09-07 - A minimal dependency implementation of Apache Parquet.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,092 | 🐛 2,585 | 🌐 C++ | 📅 2026-09-07 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,681 | 🐛 2,875 | 🌐 Rust | 📅 2026-09-07 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,078 | 🐛 728 | 🌐 Java | 📅 2026-09-07 - Java-based CLI tool for exploring parquet files.
* [ODBC to Parquet](https://github.com/pacman82/odbc2parquet) ⭐ 256 | 🐛 3 | 🌐 Rust | 📅 2026-09-07 - A command-line tool to query an ODBC data source and write the result into a parquet file.
...
* [parqeye](https://github.com/kaushiksrini/parqeye) ⭐ 677 | 🐛 16 | 🌐 Rust | 📅 2026-09-06 - Peek inside Parquet files right from your terminal.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 7,047 | 🐛 1,092 | 🌐 Rust | 📅 2026-09-07 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,182 | 🐛 356 | 🌐 Rust | 📅 2026-09-07 - A columnar file format designed for high-performance data processing.
