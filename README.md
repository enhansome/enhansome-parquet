...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,082 | 🐛 2,588 | 🌐 C++ | 📅 2026-09-04 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,746 | 🐛 1,302 | 🌐 C++ | 📅 2026-09-04 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,078 | 🐛 729 | 🌐 Java | 📅 2026-09-04 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 369 | 🐛 256 | 🌐 Java | 📅 2026-09-04 - A minimal dependency implementation of Apache Parquet.
...
* [lakeql](https://github.com/earonesty/lakeql) ⭐ 10 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-31 - Pure JavaScript duck-compatible SQL query engine for Parquet and Iceberg data in object storage.
...
* [Parquet.jl](https://github.com/JuliaIO/Parquet.jl) ⭐ 128 | 🐛 37 | 🌐 Julia | 📅 2026-08-28 - Julia implementation of Parquet columnar file format reader.
...
* [ParquetSharp](https://g-research.github.io/ParquetSharp/) - A .NET wrapper over the C++ Parquet library that integrates with [.NET Arrow](https://github.com/apache/arrow-dotnet) ⭐ 39 | 🐛 44 | 🌐 C# | 📅 2026-08-31.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,082 | 🐛 2,588 | 🌐 C++ | 📅 2026-09-04 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,647 | 🐛 2,865 | 🌐 Rust | 📅 2026-09-04 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,078 | 🐛 729 | 🌐 Java | 📅 2026-09-04 - Java-based CLI tool for exploring parquet files.
* [ODBC to Parquet](https://github.com/pacman82/odbc2parquet) ⭐ 256 | 🐛 3 | 🌐 Rust | 📅 2026-09-04 - A command-line tool to query an ODBC data source and write the result into a parquet file.
...
* [parquet-cli-standalone](https://github.com/marcelmay/parquet-cli-standalone) ⭐ 5 | 🐛 0 | 🌐 Java | 📅 2026-08-31 - A JAR file for the parquet-cli tool which can be run without any dependencies.
...
* [Tad](https://github.com/antonycourtney/tad) ⭐ 3,479 | 🐛 166 | 🌐 TypeScript | 📅 2025-03-05 - An application for viewing and analyzing tabular data sets.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,094 | 🐛 17 | 🌐 Rust | 📅 2026-09-04 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
* [parqeye](https://github.com/kaushiksrini/parqeye) ⭐ 676 | 🐛 15 | 🌐 Rust | 📅 2026-09-04 - Peek inside Parquet files right from your terminal.
* [Datanomy](https://github.com/raulcd/datanomy) ⭐ 433 | 🐛 15 | 🌐 Python | 📅 2026-05-21 - A terminal-based tool for visualizing a Parquet file's metadata and structure.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,566 | 🐛 84 | 🌐 Thrift | 📅 2026-09-04 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 7,040 | 🐛 1,067 | 🌐 Rust | 📅 2026-09-04 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,177 | 🐛 365 | 🌐 Rust | 📅 2026-09-04 - A columnar file format designed for high-performance data processing.
* [F3](https://github.com/future-file-format/F3) ⭐ 765 | 🐛 1 | 🌐 Rust | 📅 2025-11-03 - A data file format that is designed with efficiency, interoperability, and extensibility in mind.
* [Nimble](https://github.com/facebookincubator/nimble) ⭐ 732 | 🐛 150 | 🌐 C++ | 📅 2026-08-07 - File format for storage of large columnar datasets.
