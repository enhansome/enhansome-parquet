...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,077 | 🐛 2,598 | 🌐 C++ | 📅 2026-09-02 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,740 | 🐛 1,309 | 🌐 C++ | 📅 2026-09-02 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,078 | 🐛 733 | 🌐 Java | 📅 2026-09-01 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 367 | 🐛 251 | 🌐 Java | 📅 2026-09-02 - A minimal dependency implementation of Apache Parquet.
...
* [Parquet.Net](https://github.com/aloneguid/parquet-dotnet) ⭐ 906 | 🐛 35 | 🌐 C# | 📅 2026-08-25 - A fully managed Parquet library for .NET.
* [ParquetSharp](https://g-research.github.io/ParquetSharp/) - A .NET wrapper over the C++ Parquet library that integrates with [.NET Arrow](https://github.com/apache/arrow-dotnet) ⭐ 38 | 🐛 44 | 🌐 C# | 📅 2026-08-31.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,077 | 🐛 2,598 | 🌐 C++ | 📅 2026-09-02 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,591 | 🐛 2,868 | 🌐 Rust | 📅 2026-09-02 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,078 | 🐛 733 | 🌐 Java | 📅 2026-09-01 - Java-based CLI tool for exploring parquet files.
* [ODBC to Parquet](https://github.com/pacman82/odbc2parquet) ⭐ 256 | 🐛 3 | 🌐 Rust | 📅 2026-08-25 - A command-line tool to query an ODBC data source and write the result into a parquet file.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,093 | 🐛 15 | 🌐 Rust | 📅 2026-09-01 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
* [parqeye](https://github.com/kaushiksrini/parqeye) ⭐ 676 | 🐛 15 | 🌐 Rust | 📅 2026-08-26 - Peek inside Parquet files right from your terminal.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,563 | 🐛 88 | 🌐 Thrift | 📅 2026-09-01 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [parquet-testing](https://github.com/apache/parquet-testing) ⭐ 90 | 🐛 22 | 🌐 Python | 📅 2026-08-21 - Testing Data and Utilities for Apache Parquet.

## Related formats

* [Lance](https://github.com/lancedb/lance) ⭐ 7,024 | 🐛 1,046 | 🌐 Rust | 📅 2026-09-02 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,171 | 🐛 358 | 🌐 Rust | 📅 2026-09-02 - A columnar file format designed for high-performance data processing.
...
* [Nimble](https://github.com/facebookincubator/nimble) ⭐ 730 | 🐛 150 | 🌐 C++ | 📅 2026-08-07 - File format for storage of large columnar datasets.
