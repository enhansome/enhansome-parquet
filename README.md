...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,100 | 🐛 2,594 | 🌐 C++ | 📅 2026-09-12 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,749 | 🐛 1,335 | 🌐 C++ | 📅 2026-09-12 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,079 | 🐛 729 | 🌐 Java | 📅 2026-09-11 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 373 | 🐛 273 | 🌐 Java | 📅 2026-09-12 - A minimal dependency implementation of Apache Parquet.
...
* [Parquet.Net](https://github.com/aloneguid/parquet-dotnet) ⭐ 908 | 🐛 37 | 🌐 C# | 📅 2026-08-25 - A fully managed Parquet library for .NET.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,100 | 🐛 2,594 | 🌐 C++ | 📅 2026-09-12 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,715 | 🐛 2,892 | 🌐 Rust | 📅 2026-09-12 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,079 | 🐛 729 | 🌐 Java | 📅 2026-09-11 - Java-based CLI tool for exploring parquet files.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,101 | 🐛 18 | 🌐 Rust | 📅 2026-09-12 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
* [parqeye](https://github.com/kaushiksrini/parqeye) ⭐ 679 | 🐛 17 | 🌐 Rust | 📅 2026-09-12 - Peek inside Parquet files right from your terminal.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 7,067 | 🐛 1,141 | 🌐 Rust | 📅 2026-09-12 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,193 | 🐛 338 | 🌐 Rust | 📅 2026-09-12 - A columnar file format designed for high-performance data processing.
* [F3](https://github.com/future-file-format/F3) ⭐ 769 | 🐛 1 | 🌐 Rust | 📅 2025-11-03 - A data file format that is designed with efficiency, interoperability, and extensibility in mind.
