...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,150 | 🐛 2,541 | 🌐 C++ | 📅 2026-09-22 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,759 | 🐛 1,348 | 🌐 C++ | 📅 2026-09-22 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,081 | 🐛 729 | 🌐 Java | 📅 2026-09-22 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 378 | 🐛 265 | 🌐 Java | 📅 2026-09-22 - A minimal dependency implementation of Apache Parquet.
...
* [Parquet.Net](https://github.com/aloneguid/parquet-dotnet) ⭐ 910 | 🐛 39 | 🌐 C# | 📅 2026-08-25 - A fully managed Parquet library for .NET.
* [ParquetSharp](https://g-research.github.io/ParquetSharp/) - A .NET wrapper over the C++ Parquet library that integrates with [.NET Arrow](https://github.com/apache/arrow-dotnet) ⭐ 41 | 🐛 41 | 🌐 C# | 📅 2026-09-21.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,150 | 🐛 2,541 | 🌐 C++ | 📅 2026-09-22 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,841 | 🐛 2,910 | 🌐 Rust | 📅 2026-09-22 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,081 | 🐛 729 | 🌐 Java | 📅 2026-09-22 - Java-based CLI tool for exploring parquet files.
* [ODBC to Parquet](https://github.com/pacman82/odbc2parquet) ⭐ 256 | 🐛 3 | 🌐 Rust | 📅 2026-09-22 - A command-line tool to query an ODBC data source and write the result into a parquet file.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,588 | 🐛 87 | 🌐 Thrift | 📅 2026-09-20 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 7,106 | 🐛 1,235 | 🌐 Rust | 📅 2026-09-22 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,219 | 🐛 332 | 🌐 Rust | 📅 2026-09-22 - A columnar file format designed for high-performance data processing.
* [F3](https://github.com/future-file-format/F3) ⭐ 771 | 🐛 1 | 🌐 Rust | 📅 2025-11-03 - A data file format that is designed with efficiency, interoperability, and extensibility in mind.
