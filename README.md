...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,098 | 🐛 2,595 | 🌐 C++ | 📅 2026-09-11 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,749 | 🐛 1,334 | 🌐 C++ | 📅 2026-09-11 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,079 | 🐛 728 | 🌐 Java | 📅 2026-09-11 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 372 | 🐛 275 | 🌐 Java | 📅 2026-09-11 - A minimal dependency implementation of Apache Parquet.
...
* [ParquetSharp](https://g-research.github.io/ParquetSharp/) - A .NET wrapper over the C++ Parquet library that integrates with [.NET Arrow](https://github.com/apache/arrow-dotnet) ⭐ 39 | 🐛 44 | 🌐 C# | 📅 2026-09-10.
...
* [fastparquet](https://github.com/dask/fastparquet/) ⭐ 905 | 🐛 97 | 🌐 Python | 📅 2026-06-29 - A Python implementation of the Parquet columnar file format.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,098 | 🐛 2,595 | 🌐 C++ | 📅 2026-09-11 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,707 | 🐛 2,886 | 🌐 Rust | 📅 2026-09-11 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,079 | 🐛 728 | 🌐 Java | 📅 2026-09-11 - Java-based CLI tool for exploring parquet files.
* [ODBC to Parquet](https://github.com/pacman82/odbc2parquet) ⭐ 256 | 🐛 3 | 🌐 Rust | 📅 2026-09-11 - A command-line tool to query an ODBC data source and write the result into a parquet file.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,102 | 🐛 18 | 🌐 Rust | 📅 2026-09-09 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
* [parqeye](https://github.com/kaushiksrini/parqeye) ⭐ 679 | 🐛 16 | 🌐 Rust | 📅 2026-09-08 - Peek inside Parquet files right from your terminal.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,572 | 🐛 83 | 🌐 Thrift | 📅 2026-09-11 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 7,063 | 🐛 1,137 | 🌐 Rust | 📅 2026-09-11 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,190 | 🐛 346 | 🌐 Rust | 📅 2026-09-11 - A columnar file format designed for high-performance data processing.
...
* [Nimble](https://github.com/facebookincubator/nimble) ⭐ 734 | 🐛 150 | 🌐 C++ | 📅 2026-08-07 - File format for storage of large columnar datasets.
