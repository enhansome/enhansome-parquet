...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,072 | 🐛 2,584 | 🌐 C++ | 📅 2026-08-30 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,740 | 🐛 1,300 | 🌐 C++ | 📅 2026-08-30 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,078 | 🐛 741 | 🌐 Java | 📅 2026-08-30 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 366 | 🐛 249 | 🌐 Java | 📅 2026-08-30 - A minimal dependency implementation of Apache Parquet.
...
* [lakeql](https://github.com/earonesty/lakeql) ⭐ 10 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-30 - Pure JavaScript duck-compatible SQL query engine for Parquet and Iceberg data in object storage.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,072 | 🐛 2,584 | 🌐 C++ | 📅 2026-08-30 - The Ruby bindings of Apache Parquet, based on GObject Introspection.

### Rust

* [Polars](https://github.com/pola-rs/polars) ⭐ 39,556 | 🐛 2,878 | 🌐 Rust | 📅 2026-08-30 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,078 | 🐛 741 | 🌐 Java | 📅 2026-08-30 - Java-based CLI tool for exploring parquet files.
...
* [KoldStore](https://github.com/kalamdb/koldstore) ⭐ 5 | 🐛 52 | 🌐 Rust | 📅 2026-08-30 - PostgreSQL tiered storage that moves historical rows to Parquet while keeping the original table fully queryable and supporting updates and deletes.
...
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,090 | 🐛 15 | 🌐 Rust | 📅 2026-08-30 - A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,556 | 🐛 88 | 🌐 Thrift | 📅 2026-08-30 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 7,004 | 🐛 1,074 | 🌐 Rust | 📅 2026-08-30 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,164 | 🐛 371 | 🌐 Rust | 📅 2026-08-30 - A columnar file format designed for high-performance data processing.
