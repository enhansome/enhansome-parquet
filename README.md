...
* [Apache Arrow C++](https://github.com/apache/arrow/tree/main/cpp) ⭐ 17,031 | 🐛 2,574 | 🌐 C++ | 📅 2026-08-19 - A library with support for reading and writing Parquet files.
...
* [cudf](https://github.com/rapidsai/cudf/tree/main/java) ⭐ 9,730 | 🐛 1,317 | 🌐 C++ | 📅 2026-08-19 - Java bindings for cudf, to be able to process large amounts of data on a GPU.
* [parquet-java](https://github.com/apache/parquet-java) ⭐ 3,073 | 🐛 729 | 🌐 Java | 📅 2026-08-18 - A Java implementation of the Parquet format, owned by the Apache Software Foundation.
* [hardwood](https://github.com/hardwood-hq/hardwood) ⭐ 359 | 🐛 223 | 🌐 Java | 📅 2026-08-19 - A minimal dependency implementation of Apache Parquet.
...
* [ParquetSharp](https://g-research.github.io/ParquetSharp/) - A .NET wrapper over the C++ Parquet library that integrates with [.NET Arrow](https://github.com/apache/arrow-dotnet) ⭐ 35 | 🐛 43 | 🌐 C# | 📅 2026-08-18.
...
* [Red Parquet](https://github.com/apache/arrow/tree/main/ruby/red-parquet) ⭐ 17,031 | 🐛 2,574 | 🌐 C++ | 📅 2026-08-19 - The Ruby bindings of Apache Parquet, based on GObject Introspection.
...
* [Polars](https://github.com/pola-rs/polars) ⭐ 39,395 | 🐛 2,850 | 🌐 Rust | 📅 2026-08-19 - A DataFrame interface on top of an OLAP Query Engine that supports reading and writing Parquet files, with bindings for Python.
...
* [parquet-cli](https://github.com/apache/parquet-java/tree/master/parquet-cli) ⭐ 3,073 | 🐛 729 | 🌐 Java | 📅 2026-08-18 - Java-based CLI tool for exploring parquet files.
...
* [parqeye](https://github.com/kaushiksrini/parqeye) ⭐ 675 | 🐛 17 | 🌐 Rust | 📅 2026-08-19 - Peek inside Parquet files right from your terminal.
...
* [Parquet](https://github.com/apache/parquet-format) ⭐ 2,537 | 🐛 86 | 🌐 Thrift | 📅 2026-08-19 - The specification for Apache Parquet and Apache Thrift definitions to read and write Parquet metadata.
...
* [Lance](https://github.com/lancedb/lance) ⭐ 6,949 | 🐛 1,045 | 🌐 Rust | 📅 2026-08-19 - Modern columnar data format for ML and LLMs.
* [Vortex](https://github.com/vortex-data/vortex) ⭐ 3,144 | 🐛 361 | 🌐 Rust | 📅 2026-08-19 - A columnar file format designed for high-performance data processing.
